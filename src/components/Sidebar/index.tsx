...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute shadow-md left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-white duration-300 ease-linear dark:bg-blue-700 lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <p className= 'text-gray-900 text-3xl text-centerw-full font-bold'>Admin</p>
        </NavLink>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="/"
                        className={`group relative flex items-center gap-2.5 rounded-full px-4 py-2 font-medium text-bodydark2 duration-300 ease-in-out hover:bg-blue-800 hover:text-white dark:hover:bg-meta-4 ${
                          (pathname === '/' ||
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-black duration-300 ease-in-out hover:text-black dark:hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                              eCommerce
              ...
              <li>
                <NavLink
                  to="/calendar"
                  className={`group relative flex items-center gap-2.5 rounded-full py-2 px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:bg-blue-800 dark:hover:bg-blue-800 hover:text-white ${
              ...
              <li>
                <NavLink
                  to="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-full py-2 px-4 font-medium text-bodydark2 duration-300 ease-in-out  hover:bg-blue-800 dark:hover:bg-blue-800 hover:text-white ${
                    pathname.includes('profile') && 'bg-blue-900 dark:bg-blue-900 text-white'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/tables"
                  className={`group relative flex items-center gap-2.5 rounded-full py-2 px-4 font-medium text-bodydark2 duration-300 ease-in-out  hover:bg-blue-800 dark:hover:bg-blue-800 hover:text-white ${
                    pathname.includes('tables') && 'bg-blue-900'
                  }`}
                >
                  <svg
                    className="fill-current"
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/chart"
                  className={`group relative flex items-center gap-2.5 rounded-full py-2 px-4 font-medium text-bodydark2 duration-300 ease-in-out  hover:bg-blue-800 dark:hover:bg-blue-800 hover:text-white ${
                    pathname.includes('chart') && 'bg-blue-900'
                  }`}
                >
                  <svg
                    className="fill-current"
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-full px-4 py-2 font-medium text-bodydark2 duration-300 ease-in-out  hover:bg-blue-800 dark:hover:bg-blue-800 hover:text-white ${
